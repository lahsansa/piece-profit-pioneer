...
import { Store, Gem, TrendingUp, Star, Crown, Rocket } from "lucide-react";
...
const storePlans = [
  {
    ...
    products: 5,
    commission: 10,
    daily: { min: 9.5, max: 11.5 },
    monthly: { min: 285, max: 345 },
    yearly: { min: 3420, max: 4140 },
  },
  {
    id: "medium",
    nameAr: "متجر متوسط",
    ...
    commission: 12,
    daily: { min: 32, max: 39 },
    monthly: { min: 960, max: 1170 },
    yearly: { min: 11520, max: 14040 },
  },
  {
    id: "large",
    nameAr: "متجر كبير",
    ...
    commission: 15,
    daily: { min: 75, max: 92 },
    monthly: { min: 2250, max: 2760 },
    yearly: { min: 27000, max: 33120 },
  },
  {
    id: "xl",
    nameAr: "متجر XL",
    ...
    products: 20,
    commission: 18,
    daily: { min: 110, max: 135 },
    monthly: { min: 3300, max: 4050 },
    yearly: { min: 39600, max: 48600 },
  },
  {
    id: "premium",
    nameAr: "متجر بريميوم",
    ...
    products: 30,
    commission: 20,
    daily: { min: 180, max: 220 },
    monthly: { min: 5400, max: 6600 },
    yearly: { min: 64800, max: 79200 },
  },
  {
    id: "investor",
    nameAr: "متجر المستثمر",
    level: "LV6",
    icon: Rocket,
    ...
    products: 50,
    commission: 25,
    daily: { min: 300, max: 380 },
    monthly: { min: 9000, max: 11400 },
    yearly: { min: 108000, max: 136800 },
  },
];
        ...
        {storePlans.map((plan, i) => {
          ...
          return (
            <motion.div
              ...
              className={`bg-white rounded-2xl shadow-md overflow-hidden border ${plan.borderColor}`}
            >
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-3 border border-emerald-100">
                  <p className="text-[11px] text-emerald-700 font-bold mb-2 text-center">
                    📊 الدخل المتوقع بـ USDT
                  </p>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500">💰 يومياً</span>
                      <span className="text-sm font-bold text-emerald-600">
                        {plan.daily.min} – {plan.daily.max} USDT
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500">📅 شهرياً</span>
                      <span className="text-sm font-bold text-emerald-600">
                        {plan.monthly.min} – {plan.monthly.max} USDT
                      </span>
                    </div>
                ...
                {/* Activate button — passes plan price and name to topup page */}
                <button
